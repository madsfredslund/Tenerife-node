...
min_temp = 0.0 # Minimum outdoor temperature in centigrade permitted.
...
use_bw_for_wind = "no" # Use the Bolwood device for wind speed. Only when WXT520 is broken...
...
max_wind_side_ports = 15.0 # Maximum outdoor windspeed in meters per second permitted to blow into the side ports.
...
min_wind_side_ports = 5	# If wind speed is less than this the side ports should not open and cooling unit should run
