...
do_not_observe = ["1/1", "24/12", "25/12", "31/12"]

### SPECTROGRAPH ANDOR CCD ###
#ccd_server = "hw.sstenerife.prv"
ccd_server = "kvmtenerife.prv"
#ccd_server = "sstenerife.prv"	# Remember to change in spec_ccd_config.py as well
ccd_port = "8050"
ccd_abort_port = "8051"
...
#notify_sms_who = ["Mads", "Jens", "Ditte", "Vichi", "Rene", "Frank"]
notify_sms_who = ["Mads", "Jens", "Vichi", "Frank"]
#wakeup_sms_who = ["Mads", "Jens", "Ditte", "Vichi", "Frank", "Rene"]
#wakeup_sms_who = ["Mads", "Frank"]
wakeup_sms_who = ["Mads", "Frank"]
#notify_email_who = ["mads", "frank"]
notify_email_who = ["mads", "frank", "jens"]
#notify_error_who = ["mads", "tau-tec", "frank"]
notify_error_who = ["mads", "tau-tec", "frank"]
#notify_email_2 = ["mads"]
notify_email_2 = ["mads"]
#notify_sms_who = ["Mads"]
...
tel_focus_function_values = [0.4, 0.025, 4.0, 0.01]
tel_focus_function_values_phot = [-0.4, 0.025, 4.0, 0.01]
