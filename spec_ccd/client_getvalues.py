...
if len(sys.argv) > 1:
    id = sys.argv[1]
    if id == 'temp' or id == 'preamp' or id =='exptime' or id =='ac_mode' or id =='status' or id =='binning' or id =='readmode' or id =='hsspeed' or id =='highcap' or id =='imsize' or id == '-h' or id == '--help':
       if sys.argv[1] == '-h' or sys.argv[1] == '--help':
			print 'This is the help for get values for CCD camera.' 
