...
value = ""
try:
	value = server.acquire_an_image(options.filename, options.req_no, exptime, hsspeed, pregain, highcap, hbin, vbin, acmode, hstart, hend, vstart, vend, options.imagetyp, options.object, options.obj_ra, options.obj_dec, options.daynight, options.comment, "red")
except Exception, e:
	print 'error'
if e != None:
	print e
